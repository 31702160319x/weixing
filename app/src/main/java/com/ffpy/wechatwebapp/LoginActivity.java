        ...
        public void handleMessage(Message msg) {
            if (msg.what == 1) {
                ...
                if (user_login.getStatus().equals("登陆成功")) {
                    ...
                    Toast.makeText(LoginActivity.this, "欢迎回来!尊敬的"+user_login.getName(), Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(LoginActivity.this, user_login.getStatus(), Toast.LENGTH_SHORT).show();
                }
            }
